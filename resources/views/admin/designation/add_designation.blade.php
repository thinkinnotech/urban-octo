            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-offset-3 col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" id="add-designation">
                            <div class="box-body">
...
@section('script')
    <script>
        $("#add-designation").submit(function(e){
            $.ajax({
                url: '{{ URL::to('/admin/add-designation') }}',
                type: 'POST',
                dataType: 'json',
                beforeSend: function(){
                ...
                success: function(data) {
                    if(data.result == 'Success'){
                        ...
                        $("div.errorInLogin > span").html("Designation Addition Failed.");
