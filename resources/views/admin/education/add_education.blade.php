            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-offset-3 col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" id="add-education">
                            <div class="box-body">
...
@section('script')
    <script>
        $("#add-education").submit(function(e){
            $.ajax({
                url: '{{ URL::to('/admin/add-education') }}',
                type: 'POST',
                dataType: 'json',
                beforeSend: function(){
                    if($("#educationName").val() == ''){
                        $("div.warningInLogin > span").html("Please Input Course Name.");
                ...
                success: function(data) {
                    if(data.result == 'Success'){
                        ...
                        $("div.errorInLogin > span").html("Course Addition Failed.");
